...
export function PortfolioPage() {
  ...
  return (
    <main id="main-content" className="portfolio">
      ...
      <footer id="contact" className="portfolio-footer"><p>BUILT FOR AUGUST 29, 2026</p><p>Portfolio and selected work for Jean Pool Arias.</p><div><a href="https://github.com/JeanPoolArias" target="_blank" rel="noreferrer"><LogoGithub size={18} /> GITHUB</a><a href="https://www.linkedin.com" target="_blank" rel="noreferrer"><LogoLinkedin size={18} /> LINKEDIN</a><a href="mailto:jean.arias.dev@gmail.com">EMAIL</a></div><span className="copy-status" aria-live="polite">{copied ? 'Email copied to clipboard.' : ''}</span></footer>
    </main>
  )
}
